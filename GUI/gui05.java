...
class GUI{
    ...
    public GUI(){
        //Definir componentes
        Label etiqueta1=new Label("Etiqueta de barra");
        Label etiqueta2=new Label("Valor de la posicion");
        Button boton1=new Button("Recuperar texto de textarea");
        Button boton2=new Button("Usar seleccion de checkbox");
        Button boton3=new Button("Valor de la barra");
        ...
        Scrollbar Barra = new Scrollbar(Scrollbar.VERTICAL, 0, 20, 0, 100);
        ...
        mi_frame.add(Barra);
        mi_frame.add(boton3);
        mi_frame.add(etiqueta2);
        //Configuraciones adicionales del Frame
        mi_frame.setSize(1000,800);
        ...
        */
        ...
        Barra.addAdjustmentListener(new AdjustmentListener()
                                    {
                                        ...
                                        {
                                            etiqueta1.setText("Value: "+Barra.getValue());
                                        }
                                    }
        );
        ...
        boton3.addActionListener(
            new ActionListener()
            {
                ...
                {
                    //mi_frame.setCursor(new Cursor(Cursor.HAND_CURSOR));
                    etiqueta2.setText("valor: "+Barra.getValue());
                }
            }
        );
